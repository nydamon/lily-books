    ...
    try:
        with zipfile.ZipFile(epub_path, 'r') as epub:
            ...
            if len(content_files) < 2:
                errors.append("EPUB should have at least 2 content files (cover + chapters)")
            ...
            for file_info in content_files:
                if 'chapter' in file_info.filename:
                    ...
                    if '[Illustration]' in content:
                        ...
                        warnings.append(f"Chapter {file_info.filename} contains [Illustration] placeholder")
            ...
            if illustration_placeholders > 0:
                suggestions.append("Replace [Illustration] placeholders with actual content or remove them")
