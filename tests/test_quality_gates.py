...
from lily_books.models import ParaPair, QAReport, QAIssue
    ...
    pairs = [
        ParaPair(
            ...
            qa=QAReport(
                ...
                issues=[QAIssue(type="content", description="Critical problem", severity="critical")]
            )
        )
    ]
    ...
    pairs = [
        ParaPair(
            ...
            qa=QAReport(
                fidelity_score=95,
                readability_grade=8.0,
                issues=[QAIssue(type="style", description="Minor issue", severity="high")]
            )
        )
    ]
...
def test_multiple_paragraphs_min_fidelity():
    ...
    pairs = [
        ...
        ParaPair(
            ...
            orig="Original",
            modern="Modern",
            qa=QAReport(fidelity_score=80, readability_grade=8.0, issues=[])  # This should fail
        ),
        ParaPair(
            i=2,
            para_id="p2",
...
def test_multiple_paragraphs_readability():
    ...
    pairs = [
        ...
        ParaPair(
            ...
            orig="Original",
            modern="Modern",
            qa=QAReport(fidelity_score=95, readability_grade=15.0, issues=[])  # This should fail
        ),
        ParaPair(
            i=2,
            para_id="p2",
    ...
    pairs = [
        ParaPair(
            ...
            qa=QAReport(
                ...
                readability_grade=8.0,
                issues=[
                    QAIssue(type="style", description="High severity issue", severity="high"),
                    QAIssue(type="minor", description="Low severity issue", severity="low")
                ]
            )
        )
    ]
